<?php 
    // $list_data_tacGia = show_tacGia();
    // foreach($list_data_tacGia as &$data){
    //     $data['btn_suaTG'] = "?mod=tacGia&action=update&id={$data['id']}";
    //     $data['btn_xoa'] = "?mod=tacGia&action=xoa&id={$data['id']}";
    // }
    // unset($data);
?>
...
<div class="main-content">
    <div class="page-header">
        <h2 class="header-title">Danh Sách Tác Giả </h2> 
    </div>
    <div class="card">
        <div class="card-body">
            <div class="row m-b-30">
                ...
                <div class="col-lg-4 text-right">
                    <button class="btn btn-primary">
                        ...
                        <a href="?mod=tacGia&action=them" style="color:white;">Thêm Tác Giả</a>
                        <span></span>
                    </button>
                </div>
            </div>
            <div class="table-responsive">
                <table class="table table-hover e-commerce-table">
                    ...
                    <?php 
                        ...
                        $itemsPerPage = 10;
                        $paginationResult = paginate("tacgia", $currentPage, $itemsPerPage);
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">                           
                                    <h6 class="m-b-0 m-l-10"><?php echo $data['tenTacGia'] ?></h6>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <img class="img-fluid rounded" src="public/images/author/<?php echo $data['anh']?>" style="max-width: 60px" alt="">
                                </div>
                            </td>
                            <td class="text-right">
                                <a href="<?php echo $data['btn_suaTG'] ?>" class="btn btn-icon btn-hover btn-sm btn-rounded pull-right">
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center">
                    ...
                    for ($i = 1; $i <= $paginationResult['totalPages']; $i++) {
                        ...
                        echo "<li class='page-item $isActive'><a class='page-link' href='?mod=tacGia&action=index&page=$i'>$i</a></li>";
                    }
                    ?>
                </ul>
            </nav>
