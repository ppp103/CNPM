<footer id="tg-footer" class="tg-footer tg-haslayout">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        <div class="tg-footercol tg-widget tg-widgettopsellingauthors">
                            ...
                            <div class="tg-widgetcontent">
                                <ul>
                                    <li>
                                        <figure><a href="javascript:void(0);"><img src="public/images/author/imag-09.jpg" alt="image description"></a></figure>
                                        <div class="tg-authornamebooks">
                                            <h4><a href="javascript:void(0);">Nguyễn Nhật Ánh</a></h4>
                                            <p>21,658 Sách xuất bản</p>
                                        </div>
                                    </li>
                                    <li>
                                        <figure><a href="javascript:void(0);"><img src="public/images/author/imag-10.jpg" alt="image description"></a></figure>
                                        <div class="tg-authornamebooks">
                                            <h4><a href="javascript:void(0);">Nguyễn Phong</a></h4>
                                            <p>21,658 Sách xuất bản</p>
                                        </div>
                                    </li>
                                    <li>
                                        <figure><a href="javascript:void(0);"><img src="public/images/author/imag-11.jpg" alt="image description"></a></figure>
                                        <div class="tg-authornamebooks">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <h4>Đăng ký!</h4>
                    <h5>Đăng ký ngay để nhận được ưu đãi và thông tin mới nhất.</h5>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
    ...
    <div class="tg-footerbar">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <span class="tg-paymenttype"><img src="public/images/paymenticon.png" alt="image description"></span>
                    <span class="tg-copyright">2017 All Rights Reserved By &copy; Team 6</span>
                </div>
            </div>
        </div>
    </div>
...
<script src="public/https://maps.google.com/maps/api/js?key=AIzaSyCR-KEWAVCn52mSdeVeTqZjtqbmVJyfSus&amp;language=en"></script>
...
<script src="public/js/gmap3.js"></script>
<script src="public/js/main.js"></script>
</body>

<!-- Mirrored from exprostudio.com/html/book_library/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Feb 2023 02:30:19 GMT -->
