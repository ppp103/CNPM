                        ...
                        <div class="wp-inner">
                            ...
                            <div id="main-menu-wp" class="fl-right">
                                <ul id="main-menu" class="clearfix">
                                    ...
                                    <li>
                                        <a href="?mod=product&action=categoryProduct" title="">Sản phẩm</a>
                                    </li>
                                    <li>
                                        <a href="?mod=blog" title="">Blog</a>
                                    </li>
                                    <li>
                                        <a href="?mod=blog&action=detail" title="">Giới thiệu</a>
                                    </li>
                                    <li>
                                        <a href="?mod=blog&action=detail" title="">Liên hệ</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
